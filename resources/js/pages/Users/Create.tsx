...
export default function UsersCreate({ roles = [], permissions = [], campuses = [], flash, lang = "kh" }: UsersCreateProps) {
    ...
    useEffect(() => {
        const hasChanges =
            ...
            data.campus_id !== "" ||
            data.roles.length > 0 ||
            data.permissions.length > 0 || data.isVerified || !data.isActive;
    ...
    const breadcrumbs = [
        ...
        { title: t.createTitle, href: route("users.create") },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={translations.kh.createTitle} />
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {activeTab === 1 && (
                                <div className="space-y-6">
                                    ...
                                    {/* Permissions Input (uncomment if needed) */}
                                    {/* <div>
                            ...
                            {activeTab === 2 && (
                                <div className="space-y-6">
                                    ...
                                    {/* Campuses Input (uncomment if needed) */}
                                    {/* <div>
                                    ...
                                    <div className="flex flex-col sm:flex-row sm:space-x-8">
                                        ...
                                        <div className="flex flex-col mt-4 sm:mt-0 invisible">
                                            <div className="flex items-center space-x-2">
                                                <input
                                                    id="isActive"
                                                    type="checkbox"
